...
The Vice President for Media Services shall chair the Media Services Board (\blref{MSB}). Each year, the Vice President for Media Services shall prepare a budget for the Media Services Board, which shall be submitted to the Finacial Activities Board in accordance with the schedule provided in the society Policies and Procedures.
